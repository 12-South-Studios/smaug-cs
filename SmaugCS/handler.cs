...
namespace SmaugCS
{
    public static class handler
    {
        ...
        /*public static trv_world trvch_create(CharacterInstance ch, trv_type tp)
        {
            if (tp == trv_type.TR_CHAR_ROOM_FORW ||
                tp == trv_type.TR_CHAR_ROOM_BACK)
            {
                if (ch == null)
                {
                    LogManager.Instance.Bug("%s: NULL ch.", "trvch_create");
                    return null;
                }
                else if (ch.CurrentRoom == null)
                {
                    LogManager.Instance.Bug("%s: type %d with NULL room.", "trvch_create", tp);
                    return null;
                }
            }
            ...
            switch (tp)
            {
                case trv_type.TR_CHAR_ROOM_FORW:
                    // TODO count number of char_data in room from ch forward?
                    break;
                case trv_type.TR_CHAR_ROOM_BACK:
                    // TODO count number of char_data in room from ch backward?
                    break;

                default:
                    LogManager.Instance.Bug("%s: bad type (%d).", "trvch_create", tp);
                    return null;
            }

            trv_data newTrv = new trv_data();
            newTrv.type = tp;
            new
        }

        public static trv_data trvobj_create(ObjectInstance obj, trv_type tp)
        {
            // TODO
            return null;
        }

        public static CharacterInstance trvch_next(trv_data lc)
        {
            // TODO
            return null;
        }

        public static ObjectInstance trvobj_next(trv_data lc)
        {
            // TODO
            return null;
        }

        public static trv_world trworld_create(trv_type tp)
        {
            // TODO
            return null;
        }

        public static CharacterInstance trvch_wnext(trv_world lc)
        {
            // TODO
            return null;
        }

        public static ObjectInstance trvobj_wnext(trv_world lc)
        {
            // TODO
            return null;
        }

        public static void trworld_char_check(CharacterInstance rmv)
        {
            // TODO
        }

        public static void trworld_obj_check(ObjectInstance rmv)
        {
            // TODO
        }*/
