...
namespace SmaugCS
{
    public static class GameConstants
    {
        ...
        public static List<string> ObjectAffectStrings = new List<string>()
            {
                ...
                "(Flaming White)", "(Smouldering Red-Grey)", "(Smouldering Red-White)", 
                "(Smouldering Grey-White)", "(Magical)", "(Glowing)", 
                "(Humming)", "(Hidden)", "(Buried)", "(PROTO)", "(Trap)", 
                "the faint glow of something", "You see the faint glow of something nearby."
            };
        public static List<string> corpse_descs = new List<string>
                                                      {
        ...
        public static List<string> spell_flag = new List<string>
                                                    {
                                                        "water",
                                                        "earth",
                                                        "air",
        ...
        public static List<string> spell_saves = new List<string>
                                                     {
                                                         "none",
                                                         "poison_death",
                                                         "wands",
        ...
        public static List<string> spell_save_effect = new List<string>
                                                           {
                                                               "none",
                                                               "negate",
                                                               "eightdam",
        ...
        public static List<string> spell_damage = new List<string>
                                                      {
                                                          "none",
                                                          "fire",
                                                          "cold",
        ...
        public static List<string> spell_action = new List<string>
                                                      {
                                                          "none",
                                                          "create",
                                                          "destroy",
        ...
        public static List<string> spell_power = new List<string> { "none", "minor", "greater", "major" };

        public static List<string> spell_class = new List<string> { "none", "lunar", "solar", "travel", "summon", "life", "death", "illusion" };

        public static List<string> target_type = new List<string> { "ignore", "offensive", "defensive", "self", "objinv" };

        public static string CANT_PRAC = "Tongue";

        public static List<string> liquid_types = new List<string>() { "Beverage", "Alcohol", "Poison", "Blood" };
        public static List<string> mod_types = new List<string>() { "Drunk", "Full", "Thirst", "Bloodthirst" };
