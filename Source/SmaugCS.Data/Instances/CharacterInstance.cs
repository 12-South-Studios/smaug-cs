...
[XmlRoot("Character")]
public class CharacterInstance(long id, string name) : Instance(id, name), IVerifiable
{
    ...
    public ExtendedBitvector Act { get; set; } = new();
    ...
    public LuaInterfaceProxy LuaVM { get; set; } = new();
