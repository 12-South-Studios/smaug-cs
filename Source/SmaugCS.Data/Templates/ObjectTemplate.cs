...
public class ObjectTemplate : Template, IHasExtraFlags, IHasExtraDescriptions
{
    ...
    public void SetType(string type) => Type = Library.Common.Extensions.EnumerationExtensions.GetEnumByName<ItemTypes>(type);
    ...
    public void AddAffect(int type, int duration, int modifier, int location, int bits)
    {
            ...
            AffectData newAffect = new AffectData
            {
                ...
                Duration = duration,
                Modifier = modifier,
                Location = Library.Common.Extensions.EnumerationExtensions.GetEnum<ApplyTypes>(location)
            };
