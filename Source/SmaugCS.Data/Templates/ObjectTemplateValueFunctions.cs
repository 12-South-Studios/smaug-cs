...
{
  private static readonly Dictionary<ItemTypes, Action<dynamic, IEnumerable<int>>> DynamicValuesTable = new()
  {
  ...
  {
    DynamicValuesTable.TryGetValue(template.Type, out Action<dynamic, IEnumerable<int>> action);
