...
[XmlRoot("Area")]
public class AreaData(long id, string name) : Entity(id, name)
{
  ...
  [XmlElement] public string ResetMessage { get; set; }

  [XmlElement] public string Credits { get; set; }

  [XmlElement] public int Flags { get; set; }
  ...
  [XmlElement] public int ResetFrequency { get; set; }

  [XmlElement] public int MaximumPlayers { get; set; }

  [XmlElement] public int Version { get; set; }

  [XmlElement] public int WeatherX { get; set; }

  [XmlElement] public int WeatherY { get; set; }
