...
public static class Grip
{
  public static bool CheckGrip(CharacterInstance ch, CharacterInstance victim, IRepositoryManager dbManager = null)
  {
    ...
    SkillData skill = (dbManager ?? Program.RepositoryManager).GetEntity<SkillData>("grip");
    if (skill == null)
    ...
    comm.act(ATTypes.AT_SKILL, "$N holds $S weapon strongly, and is not disarmed.", ch, null, victim,
      ToTypes.Character);
