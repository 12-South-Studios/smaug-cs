...
public static class LuaCreateFunctions
{
  ...
  {
    return LastObjects.GetValueOrDefault(type, LastObject);
  }
  ...
  public static ExitData LuaCreateExit(string direction, long destination, string name)
  {
    ...
    ExitData newExit = new((int)dir, name)
    {
  ...
  {
    LiquidData newLiquid = new(id, name);
  ...
  {
    SkillData newSkill = new(id, name)
    {
  ...
  {
    HerbData newHerb = new(id, name) { Type = EnumerationExtensions.GetEnumIgnoreCase<SkillTypes>(type) };
  ...
  {
    SpecialFunction newSpecFun = new(_dbManager.GenerateNewId<SpecialFunction>(),
        name)
  ...
  public static CommandData LuaCreateCommand(string name, string function, int position, int level, int log,
    int flags)
  {
    CommandData newCommand = new(_dbManager.GenerateNewId<CommandData>(), name)
    {
      Flags = flags,
      Position = position,
      Level = level,
  ...
  {
    SocialData newSocial = new(_dbManager.GenerateNewId<SocialData>(), name);
  ...
  {
    SpellComponent newComponent = new()
    {
  ...
  {
    ClassData newClass = new(_dbManager.GenerateNewId<ClassData>(), name)
    {
  ...
  {
    RaceData newRace = new(_dbManager.GenerateNewId<RaceData>(), name)
    {
  ...
  {
    ClanData newClan = new(_dbManager.GenerateNewId<ClanData>(), name);
  ...
  {
    DeityData newDeity = new(_dbManager.GenerateNewId<DeityData>(), name);
  ...
  {
    LanguageData newLang = new(_dbManager.GenerateNewId<LanguageData>(), name,
