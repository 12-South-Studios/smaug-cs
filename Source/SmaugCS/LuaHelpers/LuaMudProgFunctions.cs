...
{
  [LuaFunction("LIsCarrying", "Gets true if the character is carrying the object", "Character", "Object",
    "Id to Check")]
  ...
  public static bool LuaCanSee(CharacterInstance ch, Instance target)
  {
    ...
    {
      CharacterInstance instance => ch.CanSee(instance),
      ObjectInstance instance => ch.CanSee(instance),
      _ => false
    };
  }
  ...
  public static bool LuaIsExitOpen(RoomTemplate room, int direction)
  {
    ...
    ExitData exit = room.GetExit(direction);
  ...
  public static bool LuaIsNuisance(CharacterInstance ch)
  {
    ...
    PlayerInstance player = (PlayerInstance)ch;
  ...
  public static bool LuaIsAffected(CharacterInstance ch, string affectedBy)
  {
    ...
    AffectedByTypes affected =
      Library.Common.Extensions.EnumerationExtensions.GetEnumByName<AffectedByTypes>(affectedBy);
    return ch.IsAffected(affected);
  }
