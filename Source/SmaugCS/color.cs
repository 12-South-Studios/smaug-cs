...
public static class color
{
  ...
  public static void show_colors(CharacterInstance ch)
  {
    ...
    int numColors = 0;
    foreach (string color in Program.LookupManager.GetLookups("ValidColors"))
    {
  ...
  public static string random_ansi(int type)
  {
    switch (type)
    {
      ...
      case 2:
        AnsiCodes code = EnumerationExtensions.GetEnum<AnsiCodes>(SmaugRandom.Between(1, 15));
