...
namespace SmaugCS.Constants
{
    ...
    {
        public static int OBJ_VNUM_MONEY_ONE => GameConstants.GetVnum("ObjectMoneySingle");
        public static int OBJ_VNUM_MONEY_SOME => GameConstants.GetVnum("ObjectMoneyMulti");
        public static int OBJ_VNUM_CORPSE_NPC => GameConstants.GetVnum("ObjectCorpseNPC");
        public static int OBJ_VNUM_CORPSE_PC => GameConstants.GetVnum("ObjectCorpsePC");
        ...
        public static int OBJ_VNUM_FIRE => GameConstants.GetVnum("ObjectFire");
        public static int OBJ_VNUM_TRAP => GameConstants.GetVnum("ObjectTrap");
        ...
        public static int ROOM_VNUM_LIMBO => GameConstants.GetVnum("RoomLimbo");
        public static int ROOM_VNUM_POLY = 3;
        public static int ROOM_VNUM_CHAT = 1200;
        public static int ROOM_VNUM_TEMPLE => GameConstants.GetVnum("RoomTemple");
        public static int ROOM_VNUM_ALTAR => GameConstants.GetVnum("RoomAltar");
        public static int ROOM_VNUM_SCHOOL => GameConstants.GetVnum("RoomSchool");
        ...
        public static long MOB_VNUM_DEITY => 17;
        public static long MOB_VNUM_ANIMATED_CORPSE => 5;
    }
}
