...
using SmaugCS.Config.Configuration;
...
{
  public static double DUR_CONV = 23.333333333333333333333333;
  ...
  private static void Main()
  {
    ...
    try
    {
      ...
      ILogWrapper logger = serviceProvider.GetRequiredService<ILogWrapper>();
      logger.Debug("Initializing Application");

      Settings settings = serviceProvider.GetService<Settings>();
      Config.Configuration.Constants constants = serviceProvider.GetService<Config.Configuration.Constants>();
      Vnums vnums = serviceProvider.GetService<Vnums>();
      Statics statics = serviceProvider.GetService<Statics>();
  ...
  private static void Application_OnUnhandledException(object sender,
  ...
  private static void ConfigureServices(IServiceCollection services)
  {
    ...
    Config.Configuration.Constants constants = new();
  ...
  private static IServiceProvider ConfigureAutofacServices(IServiceCollection services,
    Settings settings,
    Config.Configuration.Constants constants)
  {
    ...
    AutofacServiceProvider serviceProvider = new(_container);
  ...
  public static int advatoi(string s)
  {
    ...
    return !char.IsDigit(sb[0]) ? 0 : number;
  }
