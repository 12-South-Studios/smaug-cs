...
public sealed class RepositoryManager : IRepositoryManager
{
  ...
  public ObjInstanceRepository OBJECTS =>
    _repositories[RepositoryTypes.ObjectInstances].CastAs<ObjInstanceRepository>();

  public GenericRepository<T> GetRepository<T>(RepositoryTypes type) where T : class
  {
    return _repositories.TryGetValue(type, out object value) ? value.CastAs<GenericRepository<T>>() : null;
  }
