...
public class LuaCreateFunctionTests
{
  ...
  public LuaCreateFunctionTests()
  {
    ...
    LuaFunctionRepository luaFuncRepo = LuaHelper.Register(typeof(LuaCreateFunctions), null);
  ...
  public void LuaCreateMudProgTest()
  {
    ...
    MudProgData result = LuaCreateFunctions.LastObject.CastAs<MudProgData>();
  ...
  public void LuaCreateShopTest()
  {
    ...
    ShopData result = LuaCreateFunctions.LastObject.CastAs<ShopData>();
    ...
    ItemShopData itemShop = result.CastAs<ItemShopData>();
  ...
  public void LuaCreateResetTest()
  {
    ...
    ResetData result = LuaCreateFunctions.LastObject.CastAs<ResetData>();
  ...
  public void LuaCreateLiquid_Test()
  {
    ...
    LiquidData result = LuaCreateFunctions.LastObject.CastAs<LiquidData>();
  ...
  public void LuaCreateHerb_Test()
  {
    ...
    HerbData result = LuaCreateFunctions.GetLastObject(typeof(HerbData)).CastAs<HerbData>();
  ...
  public void LuaCreateSkill_Test()
  {
    ...
    SkillData result = LuaCreateFunctions.GetLastObject(typeof(SkillData)).CastAs<SkillData>();
  ...
  public void LuaCreateSmaugAffect_Test()
  {
    ...
    SmaugAffect result = LuaCreateFunctions.LastObject.CastAs<SmaugAffect>();
  ...
  public void LuaCreateSpecialFunction_Test()
  {
    ...
    SpecialFunction result = LuaCreateFunctions.LastObject.CastAs<SpecialFunction>();
  ...
  public void LuaCreateCommand_Test()
  {
    ...
    CommandData result = LuaCreateFunctions.LastObject.CastAs<CommandData>();
  ...
  public void LuaCreateSocial_Test()
  {
    ...
    SocialData result = LuaCreateFunctions.LastObject.CastAs<SocialData>();
  ...
  public void LuaCreateSpellComponent_Test()
  {
    ...
    SpellComponent result = LuaCreateFunctions.LastObject.CastAs<SpellComponent>();
  ...
  public void LuaCreateClassTest()
  {
    ...
    ClassData result = LuaCreateFunctions.LastObject.CastAs<ClassData>();
  ...
  public void LuaCreateClass_AddSkill_Test()
  {
    ...
    ClassSkillAdeptData skillAdept = result.Skills.FirstOrDefault(x => x.Skill.Equals("aggressive style"));
  ...
  {
    string script = GetClassLuaScript();
  ...
  public void LuaCreateRaceTest()
  {
    ...
    RaceData result = LuaCreateFunctions.LastObject.CastAs<RaceData>();
  ...
  public void LuaCreateDeityTest()
  {
    ...
    DeityData result = LuaCreateFunctions.LastObject.CastAs<DeityData>();
  ...
  public void LuaCreateLanguageTest()
  {
    ...
    LanguageData result = LuaCreateFunctions.LastObject.CastAs<Language.LanguageData>();
