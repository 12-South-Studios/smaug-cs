...
public class LanguageDataTests
{
  ...
  {
    LanguageData lang = new(1, "elvish", LanguageTypes.Elven) { Alphabet = "iqqdakvtujfwghepcrslybszoz" };
  ...
  {
    LanguageData lang = GetLanguageData();

    string result = lang.Translate(100, "The stars and moon are up.");
  ...
  public void Translate_ZeroPercent_Test()
  {
    ...
    string result = lang.Translate(0, "The star and moon are up.");
  ...
  public void DoPreConversion_ZeroPercent_Test()
  {
    ...
    string result = lang.DoPreConversion(0, "star and moon");
  ...
  public void DoPreConversion_100Percent_Test()
  {
    ...
    string result = lang.DoPreConversion(100, "star and moon");
  ...
  public void DoPostConversion_ZeroPercent_Test()
  {
    ...
    string result = lang.DoPostConversion(0, "array");
  ...
  public void DoPostConversion_100Percent_Test()
  {
    ...
    string result = lang.DoPostConversion(100, "array");
  ...
  public void DoCharacterConversion_ZeroPercent_Test()
  {
    ...
    string result = lang.DoCharacterConversion(0, "abcd");
  ...
  public void DoCharacterConversion_100Percent_Test()
  {
    ...
    string result = lang.DoCharacterConversion(100, "abcd");
