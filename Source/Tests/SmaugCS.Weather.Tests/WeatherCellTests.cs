...
public class WeatherCellTests
{
  ...
  {
    WeatherCell cell = new(1) { Temperature = startValue };
  ...
  {
    WeatherCell cell = new(1) { Precipitation = startValue };
  ...
  {
    WeatherCell cell = new(1) { Pressure = startValue };
  ...
  {
    WeatherCell cell = new(1) { Energy = startValue };
  ...
  {
    WeatherCell cell = new(1) { CloudCover = startValue };
  ...
  {
    WeatherCell cell = new(1) { Humidity = startValue };
  ...
  {
    WeatherCell cell = new(1) { WindSpeedX = startValue };
  ...
  {
    WeatherCell cell = new(1) { WindSpeedY = startValue };
