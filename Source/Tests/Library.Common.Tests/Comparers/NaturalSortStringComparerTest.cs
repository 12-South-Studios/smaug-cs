...
using Library.Common.Comparers;
using Xunit;

namespace Library.Common.Tests.Comparers;
...
public class NaturalSortStringComparerTest
{
  ...
  [InlineData(new object[] { "Test", "5", "Tester15", "Tester25", "04", "15Test" },
    new object[] { "04", "5", "15Test", "Test", "Tester15", "Tester25" }, true)]
  ...
  [InlineData(new object[] { "Test", "5", "Tester15", "Tester25", "04", "15Test" },
    new object[] { "Tester25", "Tester15", "Test", "15Test", "5", "04" }, false)]
  public void NaturalSortStringComparerStandardTest(object[] values, object[] expectedList, bool ascending)
  {
    ...
    bool result = expectedList.SequenceEqual(sortedList);
