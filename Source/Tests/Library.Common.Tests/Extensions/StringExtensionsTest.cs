...
public class StringExtensionsTest
{
  ...
  public void ToByteArrayValidTest()
  {
    ...
    IEnumerable<byte> actual = value.ToByteArray();
  ...
  {
    bool result = source.Contains(target, StringComparison.OrdinalIgnoreCase);
  ...
  public void ReplaceFirstNullValueTest()
  {
    ...
    Action act = () => string.Empty.ReplaceFirst(target, replace);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  {
    Action act = () => string.Empty.CapitalizeFirst();
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  public void ParseWordTest()
  {
    ...
    str.ParseWord(wordNumber, delimiter).Should().Be(expected);
  }
  ...
  public void ParseWordNullValueTest()
  {
    ...
    Action act = () => string.Empty.ParseWord(wordNbr, delimiter);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  public void PadStringNullValueTest()
  {
    ...
    Action act = () => string.Empty.PadString(padChar, totalLength);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  {
    string result = inputString.RemoveWord(wordNumber);
  ...
  public void RemoveWordNullValueTest()
  {
    ...
    Action act = () => string.Empty.RemoveWord(wordNumber);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  public void TrimTest()
  {
    ...
    str.Trim(delimiter).Should().Be(expected);
  }
  ...
  public void TrimNullValueTest()
  {
    ...
    Action act = () => string.Empty.Trim(delimiter);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  public void SplitNullValueTest()
  {
    ...
    Action act = () => StringExtensions.Split(string.Empty, delimiters);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  public void SplitTest()
  {
    ...
    List<string> expected = ["this", "is", "a", "test"];
    string[] actual = value.Split(delimiters);
  ...
  {
    Action act = () => string.Empty.ParseQuantity();
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  public void ReplaceAllNullValueTest()
  {
    ...
    Action act = () => string.Empty.ReplaceAll(chars, replace);
    act.Should().Throw<ArgumentNullException>();
  }
  ...
  {
    ArticleAppendOptions options = ArticleAppendOptions.None;
    if (appendNewLine)
    ...
    string result = value.AddArticle(options);
    result.Should().Be(expected);
  }
  ...
  public void AddArticleTest_NewLine()
  {
    ...
    string result = value.AddArticle(ArticleAppendOptions.NewLineToEnd);
    result.Should().Be(expected);
  }
  ...
  {
    const ArticleAppendOptions options = ArticleAppendOptions.None | ArticleAppendOptions.NewLineToEnd;
  ...
  {
    CaseCompareResult result = value.CaseCompare(compare);
    result.Should().Be(expected);
  }
  ...
  public void ToWordsTest()
  {
    ...
    List<string> actual = value.ToWords();
