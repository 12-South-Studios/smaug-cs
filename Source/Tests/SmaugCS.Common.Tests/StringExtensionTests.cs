...
public class StringExtensionTests
{
  ...
  {
    string result = defaultChar == null ? value.SmashTilde() : value.SmashTilde(defaultChar);
  ...
  {
    string result = hiddenChar == null ? value.HideTilde() : value.HideTilde(hiddenChar);
    result.Should().Be(expected);
  }
  ...
  {
    string result = hiddenChar == null ? value.UnhideTilde() : value.UnhideTilde(hiddenChar);
    result.Should().Be(expected);
  }
