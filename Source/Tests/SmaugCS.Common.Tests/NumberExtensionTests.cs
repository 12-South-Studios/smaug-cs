...
{
  private enum FakeEnumWithoutFlags
  {
    One,
    Two
  }
  ...
  [Flags]
  private enum FakeEnumWithFlags
  {
    One = 1,
    Two = 2,
    Four = 4
  ...
  private static readonly string[] Flags = ["a", "b", "c", "d", "e", "f", "g", "h", "i"];
  ...
  public void GetFlagString()
  {
    ...
    val.GetFlagString(Flags).Should().Be("cd");
  }
  ...
  public void Interpolate()
  {
    ...
    int actual = number.Interpolate(value00, value32);
