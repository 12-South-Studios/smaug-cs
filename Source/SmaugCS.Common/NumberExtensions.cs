...
public static class NumberExtensions
{
  ...
  {
    if (bit.GetType().GetCustomAttributes(typeof(FlagsAttribute), true).Length == 0) return false;
  ...
  {
    if (bit.GetType().GetCustomAttributes(typeof(FlagsAttribute), true).Length == 0) return 0;
    int bitValue = bit.GetValue();
  ...
  public static int GetNumberThatIsBetween(this int numberToCheck, int numberThatIsMinimumValue,
    int numberThatIsMaximumValue)
  {
  ...
  public static long GetNumberThatIsBetween(this long numberToCheck, long numberThatIsMinimumValue,
    long numberThatIsMaximumValue)
  {
    if (numberToCheck < numberThatIsMinimumValue) return numberThatIsMinimumValue;
    return numberToCheck > numberThatIsMaximumValue ? numberThatIsMaximumValue : numberToCheck;
  }
