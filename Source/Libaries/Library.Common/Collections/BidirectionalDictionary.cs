...
public class BidirectionalDictionary<TFirst, TSecond>
{
  ...
  private static readonly ConcurrentBag<TFirst> EmptyFirstList = [];
  private static readonly ConcurrentBag<TSecond> EmptySecondList = [];
  ...
  public IEnumerable<TFirst> GetBySecond(TSecond second) =>
    Backward.TryGetValue(second, out IEnumerable<TFirst> value) ? value : EmptyFirstList;
