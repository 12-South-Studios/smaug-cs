namespace Realm.Library.Network.Ansi
{
    public class AnsiBackgroundColors
    {
        public const string BlinkOn = "^A";
        public const string BlinkOff = "^a";
        ...
        public const string Brown = "^y";
        public const string Gray = "^w";
        public const string DarkGray = "^d";
        ...
        public const string LightPurple = "^P";
