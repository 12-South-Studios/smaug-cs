...
namespace SmaugCS.Weather.Tests
{
    ...
    public class WeatherCellTests
    {
        ...
        {
            var cell = new WeatherCell {Temperature = startValue};
        ...
        {
            var cell = new WeatherCell { Precipitation = startValue };
        ...
        {
            var cell = new WeatherCell { Pressure = startValue };
        ...
        {
            var cell = new WeatherCell { Energy = startValue };
        ...
        {
            var cell = new WeatherCell { CloudCover = startValue };
        ...
        {
            var cell = new WeatherCell { Humidity = startValue };
        ...
        {
            var cell = new WeatherCell { WindSpeedX = startValue };
        ...
        {
            var cell = new WeatherCell { WindSpeedY = startValue };
