...
function FirstFloorMobs()
	...
	mobile.this = CreateMobile(10001, "chalan cook", "Chalan Ma'Ganor, Cook");
	...
	mobile.this = CreateMobile(10002, "rashan leftenant soldier", "Leftenant Rashan Aseph");
	...
	mobile.this = CreateMobile(10003, "liase healer", "Liase Al'verran");
	...
	mobile.this = CreateMobile(10004, "natania child", "Natania Ma'Ganor");
	...
	mobile.this = CreateMobile(10005, "alania elf", "Alania Telkhat, Healer");
	...
	mobile.this = CreateMobile(10006, "attan sailor", "Captain Attan Al'sha'if");
	...
	mobile.this = CreateMobile(10007, "patron", "Bar Patron");
	...
	mobile.this = CreateMobile(10008, "adventurer weary", "Weary Adventurer");
	...
	mobile.this = CreateMobile(10009, "barmaid server", "Barmaid");
	...
	mobile.this = CreateMobile(10010, "bouncer", "Burly Bouncer");
	...
	mobile.this = CreateMobile(10011, "storyteller bard", "Lively Bard");
	...
	mobile.this = CreateMobile(10018, "cat tabby", "Tabby Cat");
...
function SecondFloorMobs()
	...
	mobile.this = CreateMobile(10012, "arina noble", "Arina Tal'shon");
	mobile.this.LongDescription = ";
	mobile.this.Description = [[]];
	mobile.this.Gender = "female";

	mobile.this = CreateMobile(10013, "ismail servant", "Ismail Nikhet");
	mobile.this.LongDescription = ";
	mobile.this.Description = [[]];
	mobile.this.Race = "elf";
	mobile.this.Speaks = "common elven";

	mobile.this = CreateMobile(10014, "dazhor dwarf mercenary", "Dazhor Ren");
	mobile.this.LongDescription = ";
	mobile.this.Description = [[]];
	...
	mobile.this = CreateMobile(10015, "manservant old elder", "Elderly Manservant");
	mobile.this.LongDescription = ";
	mobile.this.Description = [[]];
	mobile.this.Gender = "male";

	mobile.this = CreateMobile(10016, "mercenary veteran", "Grizzled Mercenary");
	mobile.this.LongDescription = ";
	mobile.this.Description = [[]];
	mobile.this.Gender = "male";
...
function BasementMobs()
	...
	mobile.this = CreateMobile(10017, "giant rat", "Giant Rat");
...
function Objects()
	...
	object.this = CreateObject(10000, "stained apron", "armor");
	...
	object.this = CreateObject(10001, "wooden spoon")
	...
	object.this = CreateObject(10002, "studded leather hauberk", "armor");
	...
	object.this = CreateObject(10003, "linen pants", "armor");
	...
	object.this = CreateObject(10004, "heavy leather boots", "armor");
	...
	object.this = CreateObject(10005, "fine blue cloak", "armor");
	...
	object.this = CreateObject(10006, "longsword", "weapon");
	...
	object.this = CreateObject(10007, "parchment roll", "paper");
	...
	object.this = CreateObject(10008, "long silk robe", "armor");
	...
	object.this = CreateObject(10009, "fine slippers", "armor");
	...
	object.this = CreateObject(10010, "symbol of melesa", "weapon");
	...
	object.this = CreateObject(10011, "wrinkled tunic", "armor");
	...
	object.this = CreateObject(10012, "linen hose", "armor");
	object.this.ShortDescription = "some linen hose";
	object.this.LongDescription = "You see some linen hose here.";
	object.this.WearFlags = "take legs";
	object.this:SetStats(10, 250, 0, 0, 0);
	
	object.this = CreateObject(10013, "battered pot", "drinkcontainer");
...
function FirstFloorRooms()
	...
	room.this = CreateRoom(10000, "A wood-paneled room", "inside", area.this);
	...
	AddExitToRoom(room.this, "east", 10001, "A wooden door is to the east", "isdoor closed");
	AddObjectToRoom(room.this, 10048, 10000, 1);	-- Fireplace
	AddDoorReset(room.this, "north", "closed");	-- Close the Door
	
	room.this = CreateRoom(10001, "Common Room (Northwest)", "inside", area.this);
	...
	room.this:AddExit(10002, "east", "A path amongst the tables leads east");
	room.this:AddExit(10003, "south", "A path amongst the tables leads south");
	room.this:AddExit(10004, "north", "An arched doorway leads out of the Common Room");
	room.this:AddExit(10000, "west", "A wooden door leads west out of the room");
	AddObjectToRoom(room.this, 10033, 10001, 1);	-- Table
	AddObjectToRoom(room.this, 10032, 10001, 1);	-- Candelabra
	SetupBarPatron(room.this, 10001, 2);			-- Bar Patron	
	SetupWearyAdventurer(room.this, 10001, 1);	-- Weary Adventurer
	AddDoorReset(room.this, "west", "closed");	-- Close the Door
	
	room.this = CreateRoom(10002, "Common Room (North)", "inside", area.this);
	...
	room.this:AddExit(10001, "west", "A path amongst the tables leads west");
	room.this:AddExit(10005, "east", "A path amongst the tables leads east");
	room.this:AddExit(10007, "south", "A path amongst the tables leads south");
	AddObjectToRoom(room.this, 10031, 10002, 1);	-- Large Cask
	AddObjectToRoom(room.this, 10032, 10002, 1);	-- Candelabra
	SetupBarmaid(room.this, 10002, 1);			-- Barmaid
	
	-- Bron Ma'Ganor
	reset.this = AddMobileToRoom(room.this, 10000, 10002, 1);
	EquipOnMobile(reset.this, 10000, 3);
	EquipOnMobile(reset.this, 10045, 0);

	-- Bron's Items for Sale
	GiveToMobile(reset.this, 10026, 99);			-- Mug of Ale
	GiveToMobile(reset.this, 10027, 99);			-- Glass of Wine
	GiveToMobile(reset.this, 10028, 99);			-- Day-old Bread
	GiveToMobile(reset.this, 10029, 99);			-- Bowl of Stew
	GiveToMobile(reset.this, 10030, 99);			-- Hunk of Hard Cheese

	room.this = CreateRoom(10003, "Common Room (Southwest)", "inside", area.this);
	room.this.Description = [[This huge room is noisy and filled with numerous tables, patrons, and above all else, 
	noise.  Dozens of people of all stripes, creeds, and origin are enjoying themselves at the tables while a host of 
	...
	room.this:AddExit(10001, "north", "A path amongst the tables leads north");
	room.this:AddExit(10007, "east", "A path amongst the tables leads east");
	room.this:AddExit(10014, "up", "A stairwell to the west leads up");
	AddObjectToRoom(room.this, 10033, 10003, 1);	-- Table
	AddObjectToRoom(room.this, 10032, 10003, 1);	-- Candelabra
	SetupBarmaid(room.this, 10003, 1);			-- Barmaid
